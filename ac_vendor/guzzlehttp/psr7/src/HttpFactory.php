...
use AcVendor\Psr\Http\Message\RequestFactoryInterface;
use AcVendor\Psr\Http\Message\RequestInterface;
use AcVendor\Psr\Http\Message\ResponseFactoryInterface;
use AcVendor\Psr\Http\Message\ResponseInterface;
use AcVendor\Psr\Http\Message\ServerRequestFactoryInterface;
use AcVendor\Psr\Http\Message\ServerRequestInterface;
use AcVendor\Psr\Http\Message\StreamFactoryInterface;
use AcVendor\Psr\Http\Message\StreamInterface;
use AcVendor\Psr\Http\Message\UploadedFileFactoryInterface;
use AcVendor\Psr\Http\Message\UploadedFileInterface;
use AcVendor\Psr\Http\Message\UriFactoryInterface;

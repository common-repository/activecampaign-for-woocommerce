...
use AcVendor\GuzzleHttp\Handler\CurlHandler;
use AcVendor\GuzzleHttp\Handler\CurlMultiHandler;
use AcVendor\GuzzleHttp\Handler\Proxy;
use AcVendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \AcVendor\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
